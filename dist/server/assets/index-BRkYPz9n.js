...
const BakeHistoryCard = ({ date: date2, name, score: score2, hydration, temp }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles.historyCard, children: [
    /* @__PURE__ */ jsxs("div", { className: styles.cardHeader, children: [
      /* @__PURE__ */ jsx("span", { className: styles.date, children: date2 }),
      /* @__PURE__ */ jsxs("span", { className: styles.score, children: [
        "★ ",
        score2,
        "/10"
      ] })
    ] }),
    /* @__PURE__ */ jsx("h4", { className: styles.bakeName, children: name }),
    /* @__PURE__ */ jsxs("div", { className: styles.statsRow, children: [
      /* @__PURE__ */ jsxs("div", { className: styles.stat, children: [
        /* @__PURE__ */ jsx("span", { className: styles.statLabel, children: "Hydration" }),
        /* @__PURE__ */ jsxs("span", { className: styles.statValue, children: [
          hydration,
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: styles.stat, children: [
        /* @__PURE__ */ jsx("span", { className: styles.statLabel, children: "Temp" }),
        /* @__PURE__ */ jsxs("span", { className: styles.statValue, children: [
          temp,
          "°C"
        ] })
...
const HistoryDashboard = () => {
  const stats = /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: styles.overviewBox, children: [
      /* @__PURE__ */ jsx("span", { className: styles.overviewLabel, children: "Total Bakes" }),
      /* @__PURE__ */ jsx("span", { className: styles.overviewValue, children: "42" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: styles.overviewBox, children: [
      /* @__PURE__ */ jsx("span", { className: styles.overviewLabel, children: "Avg Score" }),
      /* @__PURE__ */ jsx("span", { className: styles.overviewValue, children: "8.2" })
    ] })
  ] });
  return /* @__PURE__ */ jsx(PageLayout, { title: "Bake History", stats, children: /* @__PURE__ */ jsxs("div", { className: styles.wipOverlay, children: [
    /* @__PURE__ */ jsx("div", { className: styles.wipBanner, children: /* @__PURE__ */ jsx("span", { className: styles.wipText, children: "Work In Progress" }) }),
    /* @__PURE__ */ jsx("div", { className: `${styles.historyGrid} ${styles.historyGridBlurred}`, children: MOCK_HISTORY.map((bake) => /* @__PURE__ */ jsx(BakeHistoryCard, { ...bake }, bake.id)) })
  ] }) });
};
function BakeHistory() {
  return /* @__PURE__ */ jsx(HistoryDashboard, {});
}
export {
