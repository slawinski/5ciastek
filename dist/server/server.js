...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DFrH526b.js");
...
const manifest = {
  "09d7491381d119c0b83b14c6dcae0ab4f794dfc9a9d9ccf43ca11fb0e7658d24": {
    functionName: "calculateHydrationServer_createServerFn_handler",
    importer: () => import("./assets/calculateHydration-BWlVrX8F.js")
  },
  "8a66c283cec61370593f35e394e9dbe00f40e08cf2a07747f4a5a7a629385485": {
    functionName: "getBakingTipsServer_createServerFn_handler",
    importer: () => import("./assets/getBakingTips-Cyr_j5fz.js")
  },
  "d29e2ad12d2e60ae1cb8265921632bf603160b46f91b262338f747ed96ad1a39": {
    functionName: "calculateFermentationTimesServer_createServerFn_handler",
    importer: () => import("./assets/calculateFermentationTimes-pfZxAEPG.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BRN3750v.js").then((n) => n.r),
